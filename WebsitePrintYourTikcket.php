    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide"><img src="img/027.jpg" width="1400" height="480"></div>
        ...
        <div class="col-lg-3 mb-3">
                      <label class="form-label h4" style="font-weight:500;">Phone Number</h4></label>
                      <input type="text" class="form-control form-control-lg" id="phone_number" ng-model="params.phone_number" placeholder="Phone Number">
                      </div>
                      <div class="col-lg-3 mb-3">
                      <label class="form-label h4" style="font-weight:500;">Email</h4></label>
                      <input type="text" class="form-control form-control-lg" ng-model="params.email_address" placeholder="Email">
                      </div>
                      <div class="col-lg-2 mb-lg-4 " >
                      <button type="Request Code" class="btn white shadow-none costom-bg">Request Code</button>
                      </div>
                      <br>
                      <div class="container">
                      <div class="title h4 ">Bus Tickets</h4></div>
                      <div class="card mt-3 position-relative" ng-show="data.length==0">
                      <div class="card-body text-center" style="padding: 64px 15px;">
                      <p><img src="img/nodata.png" alt="no data "width="86"></p>
                      <p>No data</p>
                      </div>
                </div>
                </div>
